    ...
    <section id="inicio" style={{ background: C.white, position: "relative", overflow: "hidden" }} className="flex items-center py-10 pt-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="flex flex-col items-center gap-6 lg:-ml-8">
          <div className="mb-[clamp(-72px,-10vw,-36px)] lg:mb-0" style={{ width: "clamp(360px,46vw,600px)", maxWidth: "98vw" }}>
...
const GALLERY_ITEMS = [
  { id: "01", src: "/images/instalaciones/colibri-instalaciones-01.jpeg", alt: "Fachada del Jardín de Niños Colibrí" },
  { id: "02", src: "/images/instalaciones/colibri-instalaciones-02.jpeg", alt: "Patio principal con murales y arcoíris" },
  { id: "03", src: "/images/instalaciones/colibri-instalaciones-03.jpeg", alt: "Salón de clases del jardín" },
  { id: "04", src: "/images/instalaciones/colibri-instalaciones-04.jpeg", alt: "Área de juegos con resbaladillas" },
  { id: "05", src: "/images/instalaciones/colibri-instalaciones-05.jpeg", alt: "Biblioteca infantil" },
  { id: "06", src: "/images/instalaciones/colibri-instalaciones-06a.jpeg", alt: "Mural y espacio de juego motriz" },
  { id: "07", src: "/images/instalaciones/colibri-instalaciones-06b.jpeg", alt: "Área de estimulación y alberca de pelotas" },
  { id: "08", src: "/images/instalaciones/colibri-instalaciones-07.jpeg", alt: "Sala de estimulación infantil" },
  { id: "09", src: "/images/instalaciones/colibri-instalaciones-08.jpeg", alt: "Área de lavado adaptada para niñas y niños" },
  { id: "10", src: "/images/instalaciones/colibri-instalaciones-09.jpeg", alt: "Sanitario infantil adaptado" },
  { id: "11", src: "/images/instalaciones/colibri-instalaciones-10.jpeg", alt: "Biblioteca y rincón de lectura" },
  { id: "12", src: "/images/instalaciones/colibri-instalaciones-11.jpeg", alt: "Patio interior del jardín" },
  { id: "13", src: acompanamientoEstructurado, alt: "Acompañamiento estructurado en el salón de clases" },
  { id: "14", src: aprenderJugandoExplorando, alt: "Niñas y niños aprendiendo, jugando y explorando" },
  { id: "15", src: aprendizajeActivo, alt: "Actividad de aprendizaje activo" },
  { id: "16", src: metodologiaEmmi, alt: "Metodología EMMI en el aula" },
  { id: "17", src: "/images/galeria/clases.jpeg", alt: "Actividades cotidianas en el salón de clases" },
  { id: "18", src: tecnologiaProposito, alt: "Tecnología con propósito educativo" },
  { id: "19", src: "/images/galeria/explorar.jpeg", alt: "Niñas y niños explorando y descubriendo" },
  { id: "20", src: pinturaCreatividad, alt: "Taller de pintura y creatividad" },
  { id: "21", src: "/images/galeria/creatividad.jpeg", alt: "Actividad artística y de creatividad" },
  { id: "22", src: ecologia, alt: "Actividad de ecología" },
  { id: "23", src: natacion, alt: "Actividad de natación" },
  { id: "24", src: musicaEstudiantina, alt: "Clase de música y estudiantina" },
  { id: "25", src: "/images/galeria/educacion-fisica.jpeg", alt: "Clase de educación física" },
  { id: "26", src: "/images/galeria/estudiantina-evento.jpeg", alt: "Presentación de estudiantina" },
  { id: "27", src: "/images/galeria/expresion-corporal.jpeg", alt: "Actividad de expresión corporal" },
  { id: "28", src: "/images/galeria/cocina.jpeg", alt: "Actividad de cocina para niñas y niños" },
  { id: "29", src: "/images/galeria/excursiones.jpeg", alt: "Excursión y aprendizaje fuera del aula" },
  { id: "30", src: "/images/galeria/olimpiadas.jpeg", alt: "Olimpiadas y actividades deportivas" },
  { id: "31", src: "/images/galeria/princesas.jpeg", alt: "Actividad temática y de expresión creativa" },
  { id: "32", src: "/images/galeria/ninos-comiendo.jpeg", alt: "Momento de alimentación y convivencia" },
  { id: "33", src: "/images/galeria/familia.jpeg", alt: "Participación de las familias en la comunidad escolar" },
  { id: "34", src: "/images/galeria/familia-2.jpeg", alt: "Familias participando en las actividades del jardín" },
  { id: "35", src: "/images/galeria/familia-dia-del-padre.jpeg", alt: "Convivencia familiar del Día del Padre" },
  { id: "36", src: "/images/galeria/amor-y-amistad.jpeg", alt: "Convivencia del Día del Amor y la Amistad" },
  { id: "37", src: "/images/galeria/amor-y-amistad-2.jpeg", alt: "Convivencia y amistad entre compañeros" },
  { id: "38", src: "/images/galeria/paz-2.jpeg", alt: "Actividad para aprender y convivir en paz" },
  { id: "39", src: "/images/galeria/paz-valor-institucional.jpeg", alt: "Actividad sobre la paz y los valores institucionales" },
  { id: "40", src: "/images/galeria/dia-del-nino.jpeg", alt: "Celebración del Día del Niño" },
  { id: "41", src: "/images/galeria/dia-del-nino-2.jpeg", alt: "Festejo y convivencia del Día del Niño" },
  { id: "42", src: "/images/galeria/festividades.jpeg", alt: "Celebraciones y festividades escolares" },
  { id: "43", src: "/images/galeria/festival-navideno-2.jpeg", alt: "Presentación del festival navideño" },
  { id: "44", src: "/images/galeria/navidad.jpeg", alt: "Festival navideño" },
  { id: "45", src: "/images/galeria/navidad-2.jpeg", alt: "Celebración navideña de la comunidad escolar" },
  { id: "46", src: "/images/galeria/graduacion.jpeg", alt: "Ceremonia de graduación" },
]
